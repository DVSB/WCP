...
<div class="mainHeadline">
	<img src="{@RELATIVE_WCF_DIR}icon/jobhandlerLogL.png" alt="" />
	...
	<table class="tableList">
		...
		{foreach from=$logs item=log}
			<tr class="{cycle values="container-1,container-2"}">
				<td class="columnJobhandlerTaskLogID"><a href="index.php?page=JobhandlerTaskLog&amp;logID={@$log.jobhandlerTaskLogID}{@SID_ARG_2ND}">{@$log.jobhandlerTaskLogID}</a></td>
				<td class="columnExecTime">{@$log.execTime|shorttime}</td>
