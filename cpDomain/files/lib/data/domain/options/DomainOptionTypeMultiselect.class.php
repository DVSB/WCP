...
class DomainOptionTypeMultiselect extends DomainOptionTypeSelect
{
	/**
	...
	public function getCondition($optionData, $value, $matchesExactly = true)
	{
		...
		return "option_value.domainOption" . $optionData['optionID'] . " = '" . implode("\n", array_map('escapeString', $value)) . "'";
	}
}
?>