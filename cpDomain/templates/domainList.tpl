			...
			<table class="tableList">
				...
				{foreach from=$domains item=domain}
					<tr class="{cycle values="container-1,container-2"}">
						...
						<td class="columnGroupName columnText">{if $domain->canEditDomain}<a title="{lang}wcf.acp.group.edit{/lang}" href="index.php?form=SubDomainEdit&amp;domainID={@$domain->domainID}{@SID_ARG_2ND}">{$domain->domainname}</a>{else}{$domain->domainname}{/if}</td>
